...
export const SocialLinkSchema = z.object({
    platform: z.enum(["LinkedIn", "GitHub", "Twitter", "Facebook", "Instagram", "StackOverflow"]).describe("The social platform name, restricted to the supported enum values.").nullable().default(null),
