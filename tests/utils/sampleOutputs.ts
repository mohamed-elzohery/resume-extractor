...
const SAMPLE_OUTPUTS: Record<BuiltInExtractorKey, unknown> = {
    contact: {
        first_name: 'John',
        last_name: 'Doe',
        phone: null,
...
export const getSampleOutput = (key: BuiltInExtractorKey) => {
