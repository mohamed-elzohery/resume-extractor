...
export declare const getUploadMocks: () => {
    uploadMock: import("vitest").Mock<(...args: any[]) => any>;
    deleteMock: import("vitest").Mock<(...args: any[]) => any>;
};
export declare const setUploadSequence: (ids: string[]) => void;
